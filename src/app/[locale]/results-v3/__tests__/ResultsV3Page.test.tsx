...
import ResultsV3Page from "../[id]/page";

// Mock next/navigation
vi.mock("next/navigation", () => ({
  useParams: () => ({ id: "test-v3-123" }),
}));
...
describe("ResultsV3Page", () => {
  ...
  it("does NOT show competitor content before email unlock", async () => {
    ...
    // Competitor-only content should NOT be visible
  ...
  it("unlocks competitor content after email submission", async () => {
    ...
    // After unlock, competitor content should appear
    await waitFor(() => {
  ...
  it("posts email with source v3_competitor_unlock", async () => {
    ...
    await waitFor(() => {
      // First call is /api/results/test-v3-123, second is /api/subscribe
      ...
      expect(body.analysis_id).toBe("test-v3-123");
    });
  });
});
